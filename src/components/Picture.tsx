...
//             <div className="flex flex-col justify-between bg-[#2A254B] text-white px-6 py-8 sm:px-8 sm:py-12 md:px-12 md:py-16 w-full md:w-[50%] lg:w-1/2 h-auto my-12">
//                 <div>
...
//             <div className="w-full md:w-[50%] lg:w-1/2 h-auto flex items-center my-12">
//                 <Image
//                     src={picture}
//                     alt="sofa picture"
